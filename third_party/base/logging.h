...
#include "third_party/base/commandlineflags.h"
#include "third_party/base/integral_types.h"
#include "third_party/base/log_severity.h"
#include "third_party/base/logging_export.h"
#include "third_party/base/macros.h"
#include "third_party/base/vlog_is_on.h"
...
class GOOGLE_GLOG_DLL_DECL NullStreamFatal : public NullStream {
 public:
  ...
  ATTRIBUTE_NORETURN ~NullStreamFatal() throw() { _exit(1); }
};
}  // namespace google
